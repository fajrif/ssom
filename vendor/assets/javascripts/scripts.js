$(document).ready(function() {
    ...
    $('.swiper-container.activities-carousel').each(function() {
        $(this).swiper({
            pagination: '.activities-carousel-wrapper .swiper-pagination',
            nextButton: '.activities-carousel-wrapper .swiper-button-next',
            prevButton: '.activities-carousel-wrapper .swiper-button-prev',
            slidesPerView: 3,
            breakpoints: {
                668: {
                    slidesPerView: 1
    ...
    $('.swiper-container.news-carousel').each(function() {
        $(this).swiper({
            pagination: '.news-carousel-wrapper .swiper-pagination',
            nextButton: '.news-carousel-wrapper .swiper-button-next',
            prevButton: '.news-carousel-wrapper .swiper-button-prev',
            slidesPerView: 3,
            breakpoints: {
                668: {
                    slidesPerView: 1
    ...
    $('.swiper-container.feeds-carousel').each(function() {
        $(this).swiper({
            pagination: '.feeds-carousel-wrapper .swiper-pagination',
            nextButton: '.feeds-carousel-wrapper .swiper-button-next',
            prevButton: '.feeds-carousel-wrapper .swiper-button-prev',
            slidesPerView: 3,
            breakpoints: {
                668: {
                    slidesPerView: 1
